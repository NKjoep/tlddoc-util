...
var processTagLib = function(filepath, callbackExecutor, index) {
	if (fs.existsSync(filepath)) {
		...
		parseString(xml, function (err, result) {
				...
				extractedTaglibrary['short-name'] = extractedTaglibrary['short-name']||extractedTaglibrary['display-name']||extractedTaglibrary['uri']||('tag'+index);
				extractedTaglibrary['display-name'] = extractedTaglibrary['display-name']||extractedTaglibrary['short-name'];
				extractedTaglibrary['tlib-version'] = extractedTaglibrary['tlib-version']||'Unknown';
